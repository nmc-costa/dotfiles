#!/bin/bash
# omarchy-radar/scripts/run.sh — thin orchestrator over radar-common/lib.sh.
#
# Three modes:
#
...
finalize_step() {
  ...
  # lives inside it) -- best-effort, never fails the run, since the
  # committed brief is what matters and the SQLite history is a queryable
  # extra on top.
