---
name: documenthits
description: 'Update an existing DOCX/LaTeX/Markdown document with new content while preserving its structure, formatting, and tone — synthesize, don''t reinvent. Use when the user says @documentHITs, "update this document", "synthesize into the doc", or asks to revise a formal deliverable in place.'
---

# documentHITs — Document Update Architect
...
2. `my/agentic_instructions/instructions/task-personas/documentHITs.md` — this task persona
3. `my/agentic_instructions/agents/documentHITs/SKILL.md` — operational protocol for the agent
