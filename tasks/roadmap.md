...
flowchart LR
    ...
    subgraph proj_dotfiles["dotfiles"]
        ...
        dotfiles-tsk-systemd-units["dotfiles-tsk-systemd-units<br/>ensure-tsk-sweep.sh + systemd units, following the existing ensure-*.sh convention"]:::in_progress
        ...
        dotfiles-tsk-chronicle-d4-d6["dotfiles-tsk-chronicle-d4-d6<br/>Chronicle slice D4-D6: /pr-finish, /chronicle miner, footer+questionario conventions"]:::in_progress
    end
...
timeline
    ...
    2026-09-25 : dotfiles-tsk-github-to-agents : dotfiles-tsk-chronicle-skill-layer : dotfiles-tsk-agent-actor-safety : dotfiles-tsk-harness-provider-model-index
```
